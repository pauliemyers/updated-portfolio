...
var step = 1.5; // how much the turtle moves with each 'F'
var angle = 120; // how much the turtle turns with a '-' or '+'
...
therules[0] = ['A', 'AF-BF+AF+BF-AF']; // first rule
therules[1] = ['B', 'BFBF']; // second rule
//TheRules are an adaptation of the rules to create a Sierpinski Triangle using the lettering provided in the original version of this document
...
function drawIt(k)
{
  if(k=='F') // draw forward
  {
    ...
    line(x1, y1, x, y); // connect the old and the new
